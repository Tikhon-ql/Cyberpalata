...
export const RoomSearch = ()=> {
    ...
    return <>
        <form onSubmit={submitSearch}>
            <input type="number" name="count" onInput={clearErrors} className="form-control" id="count" onChange={(e:any)=>{setCount((e.target.value as number))}} defaultValue={count}/>
            ...
            <input id="hours" name="hours" className="w-50" type="range" onChange={(e: any)=>{setHours((e.target.value as number))}} min = "1" max = "10" defaultValue={hours}/>

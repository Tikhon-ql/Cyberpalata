...
namespace Cyberpalata.DataProvider.Migrations
{
    ...
    [Migration("20230222154701_BatleTournamentAdding")]
    partial class BatleTournamentAdding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cyberpalata.DataProvider.Models.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("970b07f6-5a54-4b3e-90dc-1cf65ad16acb"),
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("4c46e056-67d7-4620-ae37-11db3f797cce"),
                            Name = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("Cyberpalata.DataProvider.Models.Identity.User", b =>
                {
                    b.HasOne("Cyberpalata.DataProvider.Models.Identity.Role", "Roles")
                        .WithMany()
